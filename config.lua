...
Config = {
	...
	-- NORMAL LOGS
	webhookavatar            = "",
	webhook                  = "https://discord.com/api/webhooks/1110020327460847696/BZZyqH1dJBcHoIX6X-VbZI2NtxoQO_DMBdikPrOLhE4DLUVIw99XKU3JRCYebpZeqNW1",
	...
	WebHook                  = {
		...
		logo = nil,
		footerlogo = nil,
		webhookname = "Inventory Supervisor",
		CustomInventoryTakeFrom = "https://discord.com/api/webhooks/1131682977290661990/PdNORhkPiH5eVGAiAk2sda6eiWa0dX4H7mS2R5EFpVy-CLNE-6B_i7oSrzk7WzH8VOk_",
		CustomInventoryMoveTo = "https://discord.com/api/webhooks/1131683083700158505/HnDGqGthTIoiG_eLrZ6qpfE6BBi9ZFzozcw-JvFCN52cRInWUnspQy1f_hAodwO9ptSd"
	},
	NetDupWebHook            = {
	...
	OnPlayerRespawn          = {
		Money = {
			...
			MoneyPercentage = 0.75, -- if false wont use percentage if you add number   0.1 = 10% of money user have instead of all
		},
		Items = {
			JobLock       = { "police", "doctor" },
	...
	JobsAllowed              = {
		...
		bwaterpolice = 6, 
		armapolice = 6 ,
		tumblepolice = 6 -- job name and max weapons allowed dont allow less than the above 
	},
	-- FIRST JOIN
	startItems               = {
		Consumable_Water = 5, --ITEMS SAME NAME AS IN DATABASE
	...
	maxammo                  = {
		...
		AMMO_PISTOL = 10,
		AMMO_PISTOL_EXPRESS = 10,
		AMMO_PISTOL_EXPRESS_EXPLOSIVE = 10,
		AMMO_PISTOL_HIGH_VELOCITY = 10,
		AMMO_PISTOL_SPLIT_POINT = 10,
		AMMO_REPEATER = 10,
		AMMO_REPEATER_EXPRESS = 10,
		AMMO_REPEATER_EXPRESS_EXPLOSIVE = 10,
		AMMO_REPEATER_HIGH_VELOCITY = 10,
		AMMO_REPEATER_SPLIT_POINT = 10,
		AMMO_REVOLVER = 10,
		AMMO_REVOLVER_EXPRESS = 10,
		AMMO_REVOLVER_EXPRESS_EXPLOSIVE = 10,
		AMMO_REVOLVER_HIGH_VELOCITY = 10,
		AMMO_REVOLVER_SPLIT_POINT = 10,
		AMMO_RIFLE = 10,
		AMMO_RIFLE_ELEPHANT = 10,
		AMMO_RIFLE_EXPRESS = 10,
		AMMO_RIFLE_EXPRESS_EXPLOSIVE = 10,
		AMMO_RIFLE_HIGH_VELOCITY = 10,
		AMMO_RIFLE_SPLIT_POINT = 10,
		AMMO_22 = 10,
		AMMO_22_TRANQUILIZER = 10,
		AMMO_SHOTGUN = 10,
		AMMO_SHOTGUN_BUCKSHOT_INCENDIARY = 10,
		AMMO_SHOTGUN_EXPRESS_EXPLOSIVE = 10,
		AMMO_SHOTGUN_SLUG = 10,
		AMMO_ARROW = 10,
